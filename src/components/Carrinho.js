    ...
    render(){
      ...
      (
          <div className=" top-0 z-20 w-full h-full absolute flex items-center justify-center bg-modal bg-opacity-50 bg-gray-500">
            <div className="rounded shadow p-8 m-4 max-w-xl max-h-full text-center bg-red-700">
                <div className="mb-2">
                    <h1 className="font-sans text-2xl text-center text-white font-bold">Obrigado pela compra!</h1>
                </div>
                <div className="mb-4">
                    <p className="font-sans text-base text-center text-white ">Quer continuar comprando?</p>
                </div>
                <div className="flex justify-center">
                  <button className="p-3 transition ease-in text-red-700 duration-100 bg-white uppercase hover:text-white rounded-sm hover:bg-red-900 hover:border-white border-2 border-red-500 focus:outline-none font-sans">
      ...
      let finalizarCompra= this.props.items.length ?
            (  
              <div>
                <div className="text-white p-2 flex bg-red-800 cursor-pointer border-b border-gray-100 px-12"  >
                ...
                <div className="bg-red-700 p-4 justify-center flex">
                    ...
                    border-red-900 transition">Finalizar compra</button>
                </div>
              </div>
            ):
            (
                          ...
                          <tr>
                            ...
                            <td className="capitalize text-center">
                              ...
                              <form action="" method="POST">
                                <button onClick={()=>{this.handleRemover(item.id)}} type="submit" className="text-white ">
        ...
        (  
          this.props.items.map(item=>{
                return(
                  <div>
                    <div className="text-white p-2 flex bg-red-700 cursor-pointer border-b border-gray-100 px-12"  >
                        <div className="flex-auto text-sm md:w-32">
       ...
       return(
            <div>
                <div className="md:flex justify-center md:my-6">
                  {modalCompra}
                    <div className="md:flex md:flex-col md:w-3/4 p-8 text-white bg-red-700 shadow-lg pin-r pin-y md:mr-8 md:ml-12">
                    ...
                    <div className="rounded-b border-t-0 z-10 md:w-1/4 md:ml-0 ml-12 mr-12 mt-12 md:mt-0">
                        <div className="shadow-xl w-full">
                            <div className="p-2 md:flex bg-red-700 cursor-pointer border-b border-gray-100"  >
                                <div className="md:flex-auto text-sm md:w-32">
                                    <div className="font-sans text-2xl text-center text-white font-bold">Resumo do carrinho</div>
                                </div>
                            </div>
                            {addedItemsResumo}
                            {finalizarCompra}
